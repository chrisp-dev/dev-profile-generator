...
<html lang="en">
   <head>
      ...
      <title>${data.name || "Generated Profile - Error no name"}</title>
      <style>
          @page {
            margin: 0;
          }
      ...
      <body>
         <div class="wrapper">
          <div class="photo-header">
            <img src="${data.hubdata.avatar_url}" alt="profile image" />
            <h1>Hi!</h1>
          ...
          <main class="container">
            <div class="row">
              ...
              <div class="card">
                <h2>Public Repos</h2>
                ${data.hubdata.public_repos}                  
              </div>
              <div class="card">
                <h2>Followers</h2>
                ${data.hubdata.followers}                  
              </div>
              <div class="card">
                <h2>GitHub Stars</h2>
                ${data.hubdata.public_repos}                  
